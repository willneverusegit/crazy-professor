...
1. <provocation text> -- anchor: <one-phrase link to user infrastructure>
2. <provocation text> -- anchor: <one-phrase link to user infrastructure>
3. <provocation text> -- anchor: <one-phrase link to user infrastructure>
4. <provocation text> -- anchor: <one-phrase link to user infrastructure>
5. <provocation text> -- anchor: <one-phrase link to user infrastructure>
6. <provocation text> -- anchor: <one-phrase link to user infrastructure>
7. <provocation text> -- anchor: <one-phrase link to user infrastructure>
8. <provocation text> -- anchor: <one-phrase link to user infrastructure>
9. <provocation text> -- anchor: <one-phrase link to user infrastructure>
10. <provocation text> -- anchor: <one-phrase link to user infrastructure>
